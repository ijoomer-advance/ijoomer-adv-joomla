...
class MenusJoomla3Steps extends AdminManagerJoomla3Steps
{
	...
	public function addCategory()
	{
		...
		$I->verifyNotices(false, $this->checkForNotices(), 'Menu Manager Page');
		$I->click("New");
		$I->verifyNotices(false, $this->checkForNotices(), 'Menu Manager Page New');
		$I->fillField(\MenusJ3Page::$TitleName, 'Testing1');
		$I->fillField(\MenusJ3Page::$TitleDescription, 'Testing menus items');
		$I->click("Save & Close");
		$I->see('Menu successfully saved');
	...
	public function updateCategory()
	{
		...
		$I->click('Edit');
		$I->verifyNotices(false, $this->checkForNotices(), 'Menu Manager Edit');
