...
class IjoomeradvControllerItems extends JControllerAdmin
{
	...
	function edit()
	{
		$id = $this->app->input->getArray('cid', array()); //JRequest::getVar('cid',null,'','array');
	...
	public function saveorder()
	{
		...
		$order         = $post['order']; //JRequest::getVar('order',	null,	'post',	'array');
	...
	function setDefault()
	{
		...
		$cid	= $this->app->input->getArray('cid', array()); //JRequest::getVar('cid', array(), '', 'array');
