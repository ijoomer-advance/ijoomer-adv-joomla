...
class IjoomeradvModelPushnotif extends JModelLegacy {
    ...
    function store(){
        ...
        $query="SELECT `name`, `value`
				...
				WHERE `name` in ('IJOOMER_PUSH_ENABLE_IPHONE','IJOOMER_PUSH_DEPLOYMENT_IPHONE','IJOOMER_PUSH_ENABLE_SOUND_IPHONE','IJOOMER_PUSH_ENABLE_ANDROID','IJOOMER_PUSH_API_KEY_ANDROID', 'IJOOMER_PUSH_KEY_PASSWORD_IPHONE')";
        $db->setQuery($query);
                ...
                case 'iphone':
                    if(array_key_exists('IJOOMER_PUSH_ENABLE_IPHONE', $configvalue) && $configvalue['IJOOMER_PUSH_ENABLE_IPHONE']['value'] == 1){
                        ...
                        foreach($users as $user){
                            ...
                            $options['key_pass']=$configvalue['IJOOMER_PUSH_KEY_PASSWORD_IPHONE']['value'];
