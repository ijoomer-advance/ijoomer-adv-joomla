...
<form
					...
					<td>
						<table class="table table-striped">
							...
							<tr>
								...
								<td><select size="1" class="inputbox" name="jform[menutype]" id="jform_menutype"
								            aria-invalid="false" onchange="changeimage()">
										<?php
							...
							<tr id="imageicon">
								<td><label title="" class="hasTip" for="jform_image_icon" id="jform_image_icon-lbl"
								           aria-invalid="false">Icon Image</label></td>
								<td><input type="file" value="" id="jform_image_icon" name="jform[imageicon]" class=""
								           aria-invalid="false"></td>
							</tr>
							<tr id="imagetab">
								<td><label title="" class="hasTip" for="jform_image_tab" id="jform_image_tab-lbl"
								           aria-invalid="false">Tab Image</label></td>
								<td><input type="file" value="" id="jform_image_tab" name="jform[imagetab]" class=""
								           aria-invalid="false"></td>
							</tr>

							<tr id="imagetabactive">
								<td><label title="" class="hasTip" for="jform_image_tab_active"
								           id="jform_image_tab_active-lbl" aria-invalid="false">Tab Active Image</label>
								</td>
								<td><input type="file" value="" id="jform_image_tab_active" name="jform[imagetabactive]"
								           class="" aria-invalid="false"></td>
							</tr>

							<tr>
								<td>&nbsp;</td>
								<td id="imagedescnote"><span style="font-weight: bold"><font
											color="red">Note:</font></span><br/>Please make sure the image size should
									be <font color="green">114x114 px</font></td>
							</tr>
						</table>
					</td>
					<td width="300px">
	...
	<div class="width-40 fltrt">
		...
		<input type="hidden" id="extData" name="extData"
		       value="<?php echo $app->getUserState('com_ijoomeradv.edit.item.data'); ?>"/>
	</div>
</form>
